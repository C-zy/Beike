...
tit_san.onclick = function () {
    this.parentElement.children[2].children[3].children[1].style.display = "none";
    this.parentElement.children[2].children[3].removeAttribute("class");
    this.style.display = "none";
    var a = this.parentElement.children[2].children[3].children[0].children
    console.log(a)
    for (var i = 0; i < a.length; i++) {
...
xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
        ...
        console.log(data.data[0].desc.split("/")[1])
            ...
            list1.innerHTML += `
                <li class="list-item" onclick="details(${data.data[i].id})">
                    ...
                    <div class="lists-right">
                        ...
                        <p class="price1">
                            <span class="numprice">${data.data[i].price1.split("元")[0]}</span>
                            <span>元/平</span>
                        </p>
                        <p class="city">
                            <span class="city-item">${data.data[i].desc.split("/")[4]}</span>
                            <span class="city-item">新郑大</span>
                            <span class="city-item1">建面</span>
                            <span>${data.data[i].desc.split("/")[1]}</span>
                        </p>
                        <p class="city-bottom">
                            <span>在售</span>
                            <span>视频看房</span>
